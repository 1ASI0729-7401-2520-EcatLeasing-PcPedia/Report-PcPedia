...
- [Capítulo I: Introducción](#capítulo-i-introducción-1)
  ...
  - [2.1. Competidores](#21-competidores)
    - [**HardRental Perú**](#hardrental-perú)
    - [**Thuntech**](#thuntech)
    - [**CSI Leasing Perú**](#csi-leasing-perú)
  - [2.1.1. Análisis competitivo](#211-análisis-competitivo)
  - [2.1.2. Estrategias y tácticas frente a competidores](#212-estrategias-y-tácticas-frente-a-competidores)
...
- [Capítulo V: Product Implementation, Validation \& Deployment](#capítulo-v-product-implementation-validation--deployment-1)
  - [5.1. Software Configuration Management](#51-software-configuration-management)
    ...
    - [5.1.3. Source Code Style Guide \& Conventions](#513-source-code-style-guide--conventions)
      - [HTML:](#html)
      - [CSS:](#css)
      - [JavaScript y TypeScript:](#javascript-y-typescript)
...
- [FrontEnd](#frontend)
- [BackEnd](#backend)
    - [Arranque funcional](#arranque-funcional)
    - [Swagger funcional](#swagger-funcional)
    - [Validación visual del API](#validación-visual-del-api)
    - [5.2.3.6. Services Documentation Evidence for Sprint Review](#5236-services-documentation-evidence-for-sprint-review)
    - [5.2.3.7. Software Deployment Evidence for Sprint Review](#5237-software-deployment-evidence-for-sprint-review)
  - [Railway](#railway)
  - [Render](#render)
    - [5.2.3.8. Team Collaboration Insights during Sprint](#5238-team-collaboration-insights-during-sprint)
  - [Collaboration to FrontEnd](#collaboration-to-frontend)
  - [Collaboration to BackEnd](#collaboration-to-backend)
...
|----------------------|---------------------|--------------|
| Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería. | **TB1:**<br>• *Retuerto Rodríguez, Jorge Manuel:* Se acordó la partición del trabajo y se desarrolló en conjunto para completar correctamente la entrega.<br>• *Hernández Poma, Sebastián Eduardo:* Se realizó el análisis del proyecto y se avanzó de forma colaborativa manteniendo comunicación constante.<br>• *Condori Lozano, Alessandro Ramiro:* Se decidió avanzar en conjunto para cumplir objetivos del proyecto.<br>• *Armestar Heredia, Matias Gabriel:* Tras reunión grupal se acordó el enfoque de desarrollo del proyecto.<br>• *Bendezu Navarro, Rubens Fitzgerald:* Se definió el plan de desarrollo y se inició el reporte en equipo.<br><br>**TP1:**<br>• *Retuerto Rodríguez, Jorge Manuel:* Coordinó corrección del capítulo IV y apoyó en el avance del frontend.<br>• *Hernández Poma, Sebastián Eduardo:* Corrigió el capítulo V y aportó en el desarrollo del frontend.<br>• *Condori Lozano, Alessandro Ramiro:* Corrigió el capítulo III y continuó el desarrollo del frontend.<br>• *Armestar Heredia, Matias Gabriel:* Corrigió el capítulo I y apoyó en la implementación del frontend.<br>• *Bendezu Navarro, Rubens Fitzgerald:* Corrigió el capítulo II y colaboró en el desarrollo del frontend.<br><br>**TB2:**<br>• *Retuerto Rodríguez, Jorge Manuel:* Participó en la presentación del despliegue del backend, detallando la arquitectura del sistema y resultados obtenidos.<br>• *Hernández Poma, Sebastián Eduardo:* Explicó la integración entre el frontend y backend, destacando la correcta conexión con la base de datos.<br>• *Condori Lozano, Alessandro Ramiro:* Comunicó los avances en la implementación del backend y su funcionamiento en entorno productivo.<br>• *Armestar Heredia, Matias Gabriel:* Expuso el proceso de validación mediante entrevistas con usuarios reales y recopiló feedback.<br>• *Bendezu Navarro, Rubens Fitzgerald:* Presentó el flujo de despliegue en servidor, asegurando su correcto funcionamiento en línea. <br><br>**TF1:**<br>• *Retuerto Rodríguez, Jorge Manuel:* Comunicó constantemente opiniones objetivas con respecto a la situación de la solución.<br>• *Hernández Poma, Sebastián Eduardo:* Distribuyó la carga laboral de manera homogénea teniendo como objetivo la unidad colaborativa.<br>• *Condori Lozano, Alessandro Ramiro:* Documentó su trabajo afín a los integrantes del equipo posteriormente aportando en la documentación.<br>• *Armestar Heredia, Matias Gabriel:* Explicó conceptos de importancia destinados a distintos aspectos del desarrollo del proyecto.<br>• *Bendezu Navarro, Rubens Fitzgerald:* Comentó con anticipación las actividades ya realizadas con el objetivo de evitar confusión.<br>• *Barba Estrada, Bryan Eduardo:* Compartió información de manera eficaz colaborando en distintos apartados del desarrollo. | **TB1:**<br>Establecimos objetivos claros y alcanzables, asegurándonos de cumplirlos mediante una planificación ordenada y una distribución adecuada de las tareas. Promovimos un entorno colaborativo e inclusivo, donde la comunicación constante y la coordinación entre los miembros facilitaron la integración de ideas y el avance hacia las metas planteadas. Asimismo, gestionamos de forma eficiente las herramientas digitales y las fuentes de información, garantizando que el equipo tuviera todo lo necesario para trabajar con eficacia. Finalmente, reunimos los aportes individuales para elaborar los antecedentes, definir la problemática y crear los wireframes, consolidando un proceso colectivo orientado a la calidad y a la obtención de buenos resultados.<br><br>**TP1:**<br>Profundizamos el clima de colaboración e inclusión iniciado en TB1, fortaleciendo un espacio en el que cada integrante pudo sentirse valorado y escuchado. La participación activa en la definición de metas realistas y en la asignación equitativa de tareas permitió mantener el orden y el ritmo de trabajo. Una comunicación clara del progreso favoreció la coordinación general, mientras que el uso adecuado de herramientas digitales y fuentes de información aseguró un desempeño eficiente. En conjunto, estas prácticas dieron lugar a roles complementarios y a una cultura de trabajo que reconoció tanto el aporte individual como el logro colectivo, alcanzando los objetivos mediante una planificación precisa, una distribución justa de responsabilidades y un compromiso compartido con la calidad.<br><br>**TB2:**<br>Generamos un espacio de trabajo que facilitó la cooperación entre los integrantes para cumplir con los requisitos de esta entrega. Además, mantuvimos un ambiente de respeto en todas las interacciones, tanto orales como escritas, y organizamos una asignación de tareas clara y bien estructurada. Prestamos especial atención a esta última etapa, considerándola fundamental para el proyecto que debíamos presentar como equipo.<br><br>**TF1:**<br>Elaboramos informes técnicos siguiendo los estándares propios de los proyectos de ingeniería, verificando la calidad del contenido antes de su entrega. Nos enfocamos en comunicar conceptos e ideas clave de manera clara y empática, ajustando el nivel de detalle y el estilo de redacción según el tipo de audiencia, independientemente de su área o rol. Elegimos cuidadosamente los formatos y medios más apropiados para mejorar la comprensión del mensaje y realizamos revisiones sistemáticas para asegurar que todos los criterios de calidad se cumplieran antes de la presentación final.|
| Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.| **TB1:**<br>• *Retuerto Rodríguez, Jorge Manuel:* Redactó avances del proyecto con enfoque claro y técnico.<br>• *Hernández Poma, Sebastián Eduardo:* Escribió el análisis del proyecto utilizando lenguaje técnico adecuado.<br>• *Condori Lozano, Alessandro Ramiro:* Redacción colaborativa con precisión y objetividad.<br>• *Armestar Heredia, Matias Gabriel:* Redacción clara de avances con lenguaje técnico.<br>• *Bendezu Navarro, Rubens Fitzgerald:* Redactó manteniendo estilo formal y comprensible.<br><br>**TP1:**<br>• *Retuerto Rodríguez, Jorge Manuel:* Escribió capítulo IV con precisión técnica y argumentativa.<br>• *Hernández Poma, Sebastián Eduardo:* Desarrolló el capítulo V con comunicación objetiva de resultados.<br>• *Condori Lozano, Alessandro Ramiro:* Redacción estructurada del capítulo III.<br>• *Armestar Heredia, Matias Gabriel:* Elaboración del capítulo I con objetividad.<br>• *Bendezu Navarro, Rubens Fitzgerald:* Redacción del capítulo II para público técnico diverso.<br><br>**TB2:**<br>• *Retuerto Rodríguez, Jorge Manuel:* Documentó la arquitectura del backend y el despliegue del sistema en el informe escrito.<br>• *Hernández Poma, Sebastián Eduardo:* Redactó la sección técnica sobre integración full-stack y funcionamiento en producción.<br>• *Condori Lozano, Alessandro Ramiro:* Describió la implementación del backend y los procesos de conexión con API.<br>• *Armestar Heredia, Matias Gabriel:* Sistematizó los resultados de las entrevistas de validación, presentando conclusiones objetivas.<br>• *Bendezu Navarro, Rubens Fitzgerald:* Redactó el apartado de despliegue, procesos de entorno y pruebas en servidor. <br><br>**TF1:**<br>• *Retuerto Rodríguez, Jorge Manuel:* Optimizó el backend desarrollado anteriormente para posteriormente integrarlo con el frontend, luego documentando lo realizado en el reporte en coordinación con los demás integrantes.<br>• *Hernández Poma, Sebastián Eduardo:* Optimizó el backend desarrollado anteriormente para posteriormente desplegarlo correctamente, luego documentando lo realizado en el reporte.<br>• *Condori Lozano, Alessandro Ramiro:* Optimizó el backend desarrollado anteriormente para posteriormente integrarlo con lo agregado por los demás integrantes del equipo.<br>• *Armestar Heredia, Matias Gabriel:* Optimizó el frontend desarrollado anteriormente para posteriormente integrarlo con el backend, además procuró el orden y organización en el reporte.<br>• *Bendezu Navarro, Rubens Fitzgerald:* Optimizó el backend desarrollado anteriormente documentando lo realizado en el reporte, también realizó entrevistas con el objetivo de validar la aceptación de los segmentos objetivos.<br>• *Barba Estrada, Bryan Eduardo:* Optimizó el frontend en conjunto con los demás integrantes del equipo procurando la ordenada división de actividades. | **TB1:**<br>Definimos metas precisas y realistas, y aseguramos su cumplimiento mediante una planificación ordenada y la asignación adecuada de tareas. Fomentamos un ambiente de colaboración e inclusión en el que la comunicación constante y la coordinación entre los integrantes permitieron unir ideas y avanzar hacia los objetivos. También administramos de forma eficiente las herramientas digitales y las fuentes de información, garantizando que el equipo contara con todo lo necesario para trabajar con eficacia. Finalmente, reunimos los aportes individuales para construir los antecedentes, la problemática y los wireframes, consolidando un proceso colectivo orientado a la calidad y al logro de resultados.<br><br>**TP1:**<br>Profundizamos el ambiente colaborativo e inclusivo iniciado en TB1, fortaleciendo un espacio donde cada miembro pudo sentirse reconocido y escuchado. La participación activa en la definición de metas alcanzables y en la distribución equitativa de tareas permitió conservar el orden y el progreso del proyecto. La comunicación clara de los avances contribuyó a una mejor coordinación, mientras que el uso adecuado de recursos digitales y fuentes de información aseguró un trabajo eficiente. En conjunto, estas prácticas dieron lugar a roles bien complementados y a una cultura de trabajo que valoró tanto el aporte individual como el éxito grupal, logrando los objetivos mediante una planificación rigurosa, una repartición justa de responsabilidades y un compromiso común con la calidad.<br><br>**TB2:**<br>Creamos un entorno de trabajo que facilitó la colaboración entre los integrantes para cumplir con los requerimientos de esta entrega. Además, mantuvimos un clima de respeto en todas las interacciones, tanto escritas como orales, y organizamos una distribución de tareas clara y bien estructurada. Esta última etapa recibió especial atención al considerarse un elemento fundamental para el proyecto que debíamos presentar como equipo.<br><br>**TF1:**<br>Redactamos informes técnicos siguiendo los estándares propios de los proyectos de ingeniería, verificando la calidad del contenido antes de su entrega. Procuramos comunicar conceptos e ideas clave de manera clara y con empatía, ajustando el nivel de detalle y el estilo de redacción al tipo de público, sin importar su área o cargo. Seleccionamos cuidadosamente los formatos y medios más adecuados para mejorar la comprensión del mensaje y revisamos de forma sistemática que todos los criterios de calidad estuvieran cumplidos antes de la presentación final. |
...
| ![Perfil_Barba_Bryan](assets/chapter1/Perfil_Barba_Bryan.png)                  | Barba Estrada, Bryan Eduardo - u202323479     | Ingeniería de Software | Mi nombre es Bryan Barba, soy estudiante de Ingeniería de Software en la Universidad Peruana de Ciencias Aplicadas. Me considero una persona proactiva, responsable y con habilidades para el trabajo en equipo. Estoy entusiasmado por seguir aprendiendo y creciendo en el campo de la tecnología. |
...
**Entrevista 4 – Alvaro Salazar (24 años)**  
📍Edad: 24 años  
💼 Ocupación: Estudiante Universitario  

Comentarios principales:
- Considera que la plataforma es fácil de usar y accesible.
- Resalta que el sidebar concentra todo para que lo encuentres rápido.
- Sugiere ampliar secciones como catalogo.
- Recomienda tener un boton para el perfil  
🎥 Video: https://youtu.be/OEOu_S2jbzQ
